...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('admin/training', [TrainingReviewController::class, 'index'])->name('training.index');
    Route::get('admin/training/{trainingCompletion}', [TrainingReviewController::class, 'show'])->name('training.show');
